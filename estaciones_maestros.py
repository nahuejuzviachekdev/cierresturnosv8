"""
Proceso 027 - Sincronizacion de tabla maestra: Estaciones.
...
Uso: python estaciones_maestros.py
"""
import os
import re
import sys
...
def main():
    ...
    log_path  = os.path.join(LOGS_EXEC_DIR, f'estaciones_maestros_{stamp}.txt')
    logger    = Logger(log_path)
    pg_tunnel.configurar_logging(logger.log)

    logger.log('=' * 60)
    logger.log('Estaciones Maestros -- Proceso 027')
