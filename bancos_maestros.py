"""
Proceso 028 - Sincronizacion de tabla maestra: Bancos.
...
TABLAS = [
    {'proceso': '028_Bancos', 'sql_table': 'Bancos', 'pg_table': 'bancos'},
]
...
def main():
    ...
    log_path  = os.path.join(LOGS_EXEC_DIR, f'bancos_maestros_{stamp}.txt')
    logger    = Logger(log_path)
    pg_tunnel.configurar_logging(logger.log)

    logger.log('=' * 60)
    logger.log('Bancos Maestros -- Proceso 028')
